...
* *dynamics:* $f(x_{k},u_{k}) = x_{k} + u_{k} = x_{k+1}$. In words: $x_{k+1}$ is adjacent to $x_{k}$ and the control $u_{k}$ moves the repairman to $x_{k+1}$
